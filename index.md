...
Here is a copy of my CV, last updated in December 2025: <a href="{{ site.cv_link }}" class="button" style="font-size:12px;"><i class="fas fa-file-alt" aria-hidden="true"></i>&nbsp; PDF</a>
...
<h3 style="color: #043361; font-size: 120%; margin-bottom: 3pt; padding-bottom: 0" >{{ post.title }}</h3> 
...
<p style="margin-bottom: 5px"><strong>On My Bookshelf</strong></p>
...
<p style="margin-bottom: 5px"><strong>Helpful Resources</strong></p>
...
<p style="margin-bottom: 5px"><strong>Useful LaTeX Links</strong></p>
...
<p style="margin-bottom: 5px"><strong>Some (Mathematical) Friends</strong></p>
